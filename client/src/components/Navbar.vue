    ...
    <div class="font-sans antialiased">
        <nav class="flex items-center justify-between flex-wrap bg-teal p-6">
            <div class="flex items-center flex-no-shrink text-white mr-6">
                ...
                <span class="font-bold text-3xl tracking-tight">Tailwind CSS</span>
            </div>
            ...
            <div :class="open ? 'block' : 'hidden'" class="w-full sm:flex sm:items-center sm:w-auto">
                <div class="text-sm sm:flex-grow mr-5">
                    ...
                    <router-link to="/about" class="no-underline block mt-4 sm:inline-block sm:mt-0 text-teal-lighter hover:text-white mr-4">
